...
import { Coins, Save, Loader2, Search, Tag } from 'lucide-react';
...
import { useAdminCreditCosts, useUpdateCreditCost } from '@/hooks/useDynamicCreditCosts';
...
const CreditCostsPanel = () => {
  ...
  const saveEdit = (id: string) => {
    ...
    updateCost.mutate({ id, cost_value: val });
    setEditingId(null);
  };
                        ...
                        {editingId === cost.id ? (
                          <div className="flex items-center gap-1.5">
                            <Input
                              ...
                              autoFocus
                              onKeyDown={(e) => {
                                if (e.key === 'Enter') saveEdit(cost.id);
