...
const SnapCaptureDialog = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="max-w-md max-h-[90vh] p-0 gap-0 overflow-hidden bg-black border-border [&>button:last-child]:hidden !duration-0 !animate-none">
          ...
          {!hasCapture && !cameraError && !isInitializing && (
            <div className="relative">
              ...
              >
                ...
                {/* Capture button + Lock zone side by side */}
                <div className="flex items-center justify-center gap-6">
                  ...
                  {/* Lock zone - to the right of the button */}
                  <div className="w-14 flex items-center justify-center">
                    {isRecording && !isLocked && lockHintVisible ? (
                      ...
                      >
                        ...
                        <span className="text-[10px] text-white/60">Verrouillé</span>
                      </motion.div>
                    ) : null}
                  </div>
                </div>
