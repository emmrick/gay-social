...
const SettingsInlineContent = ({ type, onBack, onContactAdmin, onClose }: SettingsInlineContentProps) => {
  ...
  const getHeaderInfo = () => {
    switch (type) {
      case 'notifications':
        return { title: 'Notifications', description: 'Personnalise tes alertes', icon: Bell, color: 'text-blue-500', bgColor: 'bg-blue-500/15' };
      case 'appearance':
        return { title: 'Apparence', description: 'Personnalise le look', icon: Palette, color: 'text-indigo-500', bgColor: 'bg-indigo-500/15' };
      case 'privacy':
        return { title: 'Confidentialité', description: 'Contrôle ta visibilité', icon: Shield, color: 'text-emerald-500', bgColor: 'bg-emerald-500/15' };
      case 'help':
        return { title: 'Aide & Support', description: 'On est là pour toi', icon: HelpCircle, color: 'text-orange-500', bgColor: 'bg-orange-500/15' };
    }
  };
            ...
            {pushSubscribed && (
              <>
                ...
                <div className="flex items-center gap-2 mb-2 px-1">
                  ...
                  <span className="text-sm font-medium text-foreground">Préférences par type</span>
                </div>
                <p className="text-[12px] text-muted-foreground px-1 mb-3">
      ...
      case 'appearance':
        return (
          <div className="space-y-2">
            ...
            <div className="mt-4 p-3.5 rounded-xl border border-border/40 bg-muted/30">
              <p className="text-sm font-medium mb-2 text-foreground">Aperçu du thème</p>
            ...
            {isAdminUser && (
              <div className="space-y-2 mt-4">
                ...
                <div className="flex items-center gap-3 min-h-[56px] p-3 rounded-xl bg-muted/50 hover:bg-muted/70 transition-colors border border-border/20">
                  ...
                  <div className="flex-1 min-w-0">
                    <Label className="font-medium text-[15px] block leading-tight text-foreground">Masquer le statut en ligne</Label>
                    <p className="text-[13px] text-muted-foreground truncate mt-0.5">
                ...
                <div className="flex items-center gap-3 min-h-[56px] p-3 rounded-xl bg-muted/50 hover:bg-muted/70 transition-colors border border-border/20">
                  ...
                  <div className="flex-1 min-w-0">
                    <Label className="font-medium text-[15px] block leading-tight text-foreground">Masquer la dernière connexion</Label>
                    <p className="text-[13px] text-muted-foreground truncate mt-0.5">
          ...
          <div className="space-y-5">
            <div className="space-y-3">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  <h4 className="font-semibold text-sm text-foreground">Questions fréquentes</h4>
              ...
              <Accordion type="single" collapsible className="space-y-1.5">
                {[
                  ...
                  <AccordionItem 
                    key={i}
                    value={`item-${i}`} 
                    className="border border-border/30 rounded-xl px-3 bg-muted/30 hover:bg-muted/50 transition-colors data-[state=open]:bg-muted/60"
                  >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <span className="font-medium text-[15px] block text-foreground">Contacter le support</span>
  ...
  return (
    <>
      ...
      {/* Sticky Footer for save actions (not for help) */}
      {type !== 'help' && (
