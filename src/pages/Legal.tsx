          ...
          <AccordionItem value="premium" className="glass-card rounded-2xl px-6 border-border">
            <AccordionTrigger className="hover:no-underline">
              <div className="flex items-center gap-3">
                ...
                <span className="font-display font-semibold text-lg">Options Premium & CGV</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="text-muted-foreground space-y-4 pt-4">
              <div>
                ...
                <p>
                  Gay Connect propose des options premium payantes qui donnent accès à 
                  certaines fonctionnalités avancées. Ces paiements servent uniquement à 
                  améliorer votre expérience sur la plateforme.
                </p>
              </div>

              <div>
                <h4 className="font-semibold text-foreground mb-2">Ce que l'option Premium inclut</h4>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Accès à des fonctionnalités exclusives</li>
                  <li>Visibilité améliorée de votre profil</li>
              ...
              <div className="bg-muted/50 rounded-xl p-4">
                <h4 className="font-semibold text-foreground mb-2">⚠️ Ce que le Premium ne garantit PAS</h4>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <p className="mt-2 text-sm">
                  L'abonnement Premium améliore votre expérience mais ne garantit aucun 
                  résultat en termes de rencontres.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  Aucun remboursement ne sera effectué après activation du service Premium.
                </p>
              </div>
            </AccordionContent>
          </AccordionItem>
