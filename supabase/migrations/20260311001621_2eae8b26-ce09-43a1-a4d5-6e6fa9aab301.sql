...
BEGIN
  ...
  -- For tasks pending > 90s without any offer, always offer immediately (no random skip)
  -- For newer tasks with other moderators online, use fair random distribution
